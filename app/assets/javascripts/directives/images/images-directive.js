...
angular.module('cnpaContestApp')
    .directive('imagesDirective', ['$http', 'fileImageService', '$location', function($http, fileImageService, $location) {
        return {
            ...
            link: function(scope) {
                scope.vm.images = scope.images;
                scope.vm.contestName = scope.contestName;
                scope.vm.folder = scope.folder;
                scope.vm.directories = scope.directories;
                scope.vm.directory = scope.directory;
